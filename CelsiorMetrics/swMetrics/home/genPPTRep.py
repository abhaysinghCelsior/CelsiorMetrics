...
from swMetrics.home.models import WeightedDefectDensity,OnTimeDelivery,QARemovalEfficiency,AutomatedUnitTestingEffectiveness,WeightedCodeReviewEffectiveness,EffortVariance
from swMetrics.home.models import MetricsBenchMark,DefectSource,RC,DefectSummary,MetricsMonth,AppMetrics,ProjectOwner
from swMetrics.home.configMet import EXT,REP_NM,REP_PATH,SMTP,FROM,PORT,EMAIL_BODY,EMAIL_TAIL,REP_NM,MET1_TITLE,MET2_TITLE,MET3_TITLE,MET4_TITLE,MET5_TITLE,MET6_TITLE,SlideNoStartingMet,NO_of_MET
